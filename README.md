...

{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# 7 fields for each record, using set data structure then adding how many we thought we were separating out or we were "
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# separating out, expecting it to be 7 but this was not the case"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# have integity with data processing and the results, be sure code is behaving the way you expect"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# TEST TEST TEST BUILD TEST IN CODE"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# VIDEO 3: didnt really answer our question, just started loading data "
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# now there's just a list of School Name, Amount, Model. Amount turned from str to int using float()"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "dataset[\"AMOUNT\"] #to get list of amounts"
   ]
  },
  {
   "cell_type": "code",
